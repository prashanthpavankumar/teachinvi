...
// ShaderBackground — generated by 21st.dev Shader Builder ("Mesh drift"). Zero dependencies: one WebGL canvas.
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      const releaseTimer = window.setTimeout(() => {
        ...
        if (canvas) pendingContextReleases.delete(canvas);
      ...
      if (canvas) pendingContextReleases.set(canvas, releaseTimer);
    };
  }, []);
